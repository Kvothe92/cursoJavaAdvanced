...
La idea de la herencia es que puedas crear nuevas clases a 
...
Asociacion(Es Un): Cuando entre dos o mas clases se da una interaccion que no
...
entre ellos mientras que dura la relacion. Es decir, un objeto que depende
de los servicios de otro a largo plazo.

Composicion(Contiene): Cuando un objeto complejo usa 
otros objetos permanentemente.
...
class Programador extends Empleado{
    ...
    void mensaje(){
        System.out.println("Soy un programadoor");
        main();
    }
}
//Herencia simple Enpleado a Programador
//Herencia multinivel Empleado a Programador - Web
//Herencia jerarquica Empleado aProgramador y empleado a Web
